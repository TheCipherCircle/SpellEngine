...
class GameClient:
    ...
    def _init_test_session(self) -> None:
        ...
        from spellengine.cli import __version__
        ...
        test_log_dir = Path.home() / ".spellengine" / "test_logs"
