"""
Content Management CLI for SpellEngine

Usage:
    python -m spellengine.content.cli rebuild
    python -m spellengine.content.cli validate
    python -m spellengine.content.cli find --tag=hashcat --difficulty=beginner
    python -m spellengine.content.cli stats
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="spellengine-content",
        description="SpellEngine Content Management",
    )
    parser.add_argument(
        "--content-root",
        type=Path,
